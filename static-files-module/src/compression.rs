...
use http::header;
use module_utils::pingora::{Error, ResponseCompression, ResponseHeader, SessionWrapper};
...
impl<'a> Compression<'a> {
    ...
    pub(crate) fn new(
        ...
        Self {
            ...
            dynamic: session
                ...
                .is_some_and(|downstream_compression| downstream_compression.is_enabled()),
        }
    }
    ...
    pub(crate) fn transform_header(
        ...
        } else if header.headers.get(header::CONTENT_ENCODING).is_some() {
